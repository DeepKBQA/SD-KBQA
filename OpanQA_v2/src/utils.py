...
def freebase_read_data(
						input_pkl_dir=r'../bertified/freebase/',
						 datatype='train'):
	'''
		reading simple question-answers dataset based on datatype
	'''
...
def reverb_read_data(path='../bertified/reverb/'):
	'''
		reading reverb questions dataset 
	'''
